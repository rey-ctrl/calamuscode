...
export default function CTASection() {
  return (
    <div id="cta-section">
      ...
      <p className="cta-sub reveal stagger-1">
        Hubungi kami sekarang via WhatsApp, bisa konsultasi 1 on 1, tanpa tekanan, respons cepat.
      </p>
      <div className="cta-actions reveal stagger-2">
        <a
